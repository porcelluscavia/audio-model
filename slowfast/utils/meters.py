...
#         self.loss_total = 0.0
#         self.slowfast_loss = ScalarMeter(cfg.LOG_PERIOD)
#         self.slowfast_loss_total = 0.0
#         self.emb_loss = ScalarMeter(cfg.LOG_PERIOD)
#         self.emb_loss_total = 0.0
#         self.lr = None
...
#         self.net_timer.reset()
#
#     def update_stats(self, top1_err, top5_err, loss, lr, mb_size, emb_loss = None, slowfast_loss = None):
#         """
...
#         if emb_loss and slowfast_loss:
#             self.emb_loss.add_value(emb_loss)
#             self.slowfast_loss.add_value(slowfast_loss)
#         self.lr = lr
...
#
#         if self._cfg.VGGSOUND.EMBEDDINGS_ENABLE:
#             stats["emb_loss"]: self.emb_loss.get_win_median()
#             stats["slowfast_loss"]: self.slowfast_loss.get_win_median()
#         logging.log_json_stats(stats)
#
...
#             stats["loss"] = avg_loss
#             if self._cfg.VGGSOUND.EMBEDDINGS_ENABLE:
#                 avg_emb_loss = self.emb_loss_total / self.num_samples
#                 avg_slowfast_loss = self.emb_slowfast_total / self.num_samples
#                 stats["emb_loss"]: avg_emb_loss
#                 stats["slowfast_loss"]: avg_slowfast_loss
#         logging.log_json_stats(stats)
#
#
